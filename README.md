...
The iOS app can configure relay details for background delivery. You normally do not need to edit relay settings manually; keep relay credentials and Home Assistant tokens private.
